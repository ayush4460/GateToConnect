          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            <div className="flex items-center gap-6 lg:gap-12">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <Link 
                  href="/about" 
                  className={`font-medium transition ${isActive('/about') ? 'text-purple-600 font-bold' : 'text-gray-700 hover:text-purple-600'}`}
                >
                  About
                </Link>
                <button onClick={() => setShowContact(true)} className="text-gray-700 hover:text-purple-600 font-medium">
                  Contact
                </button>
              </nav>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="px-6 py-8 space-y-6">
              <Link href="/about" className="block text-lg font-medium text-purple-600">About</Link>
              <button onClick={() => setShowContact(true)} className="block w-full text-left text-lg text-gray-700">
                Contact
              </button>
